...
public class SWEKConfiguration {
    ...
    /** Singleton instance */
    private static SWEKConfiguration singletonInstance;
     ...
     * private constructor
     */
    private SWEKConfiguration(){
        this.configLoaded = false;
        this.swekProperties = new Properties();
    }

    public static SWEKConfiguration getSingletonInstance(){
        if(singletonInstance == null){
            singletonInstance = new SWEKConfiguration();
        }
