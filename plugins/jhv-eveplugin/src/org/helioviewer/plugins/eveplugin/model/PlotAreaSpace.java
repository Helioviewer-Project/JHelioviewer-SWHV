...
public class PlotAreaSpace {
	...
	/*public static PlotAreaSpace getInstance(){
		if(instance == null){
			instance = new PlotAreaSpace();
		}
		return instance;
	}*/
	...
	public void setScaledSelectedTimeAndValue(double scaledSelectedMinTime, double scaledSelectedMaxTime,
