 ...
 * the component responsible for drawing the main image (e.g. by calling When
 * drawing the image, the managing component will call this interface, providing
 * a PhysicalRenderGraphics object, to allow the implementing class to draw its
