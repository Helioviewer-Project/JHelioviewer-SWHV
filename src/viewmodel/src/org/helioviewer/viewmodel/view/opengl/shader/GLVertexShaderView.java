...
/**
 * View to build vertex shaders.
 * 
 * <p>
 * To build the final vertex shader, many different code blocks are merged. To
 ...
 * it has to call the next GLVertexShaderView as well, so that every view gets
 * the chance to append its piece of code as well.
 * 
 * @author Markus Langenberg
 */
public interface GLVertexShaderView extends GLView {
     ...
     * GLVertexShaderView as well, if there is one, to ensure that all views
     * append their code to the final shader.
     * 
     * <p>
     * In most cases, this call is redirected to
     * {@link GLVertexShaderProgram#build(GLShaderBuilder)}.
     * 
     * <p>
