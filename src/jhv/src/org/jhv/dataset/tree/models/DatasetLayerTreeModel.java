...
public class DatasetLayerTreeModel {
    ...
    /*
     * Layers are added often at position 0 all subsequent layers are shifted by
     * 1
     */
    ...
    /*
     * When a given layer with given index is removed, all layers with a larger
     * index corresponding to the same interval and type are decremented.
     */
    ...
    public void setSortedLayers(TreeMap<String, TreeMap<String, ArrayList<LayerDescriptor>>> sortedLayers) {
