...
public class JP2ImageCallisto extends JP2Image {
    ...
    public JP2ImageCallisto(URI _uri, JP2View _view) throws Exception {
        super(_uri, _view);
    }
    ...
    protected JP2ImageParameter calculateParameter(Camera camera, Viewport vp, Position.Q p, int frame, double factor) {
        ...
        JP2ImageParameter params = new JP2ImageParameter(this, null, subImage, res, frame, factor, true);
        signalReader(params);
