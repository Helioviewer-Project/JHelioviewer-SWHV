...
public class Displayer implements JHVEventHighlightListener {
    ...
    private static GL3DViewport miniview = new GL3DViewport(10, 10, 75, 75, new GL3DObserverCamera(), true);

    public static GL3DViewport getMiniview() {
        return miniview;
    }

    private static GL3DViewport viewport = new GL3DViewport(0, 0, 100, 100, new GL3DObserverCamera(), false);
