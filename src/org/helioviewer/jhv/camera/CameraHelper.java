...
public class CameraHelper {
    ...
    public static void rotate2Carrington(Position viewpoint) {
        Transform.rotateViewInverse(new Quat(0, 2 * viewpoint.lon - Sun.getEarthHCI(viewpoint.time).lon - Sun.getEarth(viewpoint.time).lon));
    }
