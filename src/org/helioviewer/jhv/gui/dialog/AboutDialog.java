...
public final class AboutDialog extends StandardDialog implements Interfaces.ShowableDialog, HyperlinkListener {
    ...
    public JComponent createContentPanel() {
        String text = "<center>This software was built using several components including:</center><ul>" +
                ...
                "<li><a href=\"https://www.lwjgl.org\">LWJGL</a> Java 3D graphics libraries, <a href=\"https://chromium.googlesource.com/angle/angle\">ANGLE</a> cross-platform GLES translation layer and <a href='/licenses/Assimp.txt'>Assimp</a> model importer.</li>" +
