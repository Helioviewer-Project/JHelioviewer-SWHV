...
public class Buttons {
    ...
    public static final String collapseLeft = "<html><font face='Material Design Icons' size=3>" +
            MaterialDesign.CHEVRON_LEFT + "</font>";
    public static final String collapseRight = "<html><font face='Material Design Icons' size=3>" +
            MaterialDesign.CHEVRON_RIGHT + "</font>";

    public static final String chevronRight = "<html><font face='Material Design Icons' size=3>" +
            MaterialDesign.CHEVRON_RIGHT + "</font>&nbsp;";
    public static final String chevronDown = "<html><font face='Material Design Icons' size=3>" +
    ...
    public static final String syncLayers = "<html>&nbsp;<font face='Material Design Icons' size=4>" +
            MaterialDesign.SYNC + "</font>&nbsp;Sync All";
    ...
    public static final String stacked = "<html>&nbsp;<font face='Material Design Icons' size=4>" +
            MaterialDesign.CHART_GANTT + "</font>&nbsp;";
    public static final String overlaid = "<html>&nbsp;<font face='Material Design Icons' size=4>" +
            MaterialDesign.BORDER_ALL + "</font>&nbsp;";
