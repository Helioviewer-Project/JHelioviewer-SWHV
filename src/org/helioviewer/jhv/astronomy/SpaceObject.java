...
public class SpaceObject {
    ...
    public static final SpaceObject Sol = new SpaceObject("SUN", "Sun", 1, BufferUtils.colorYellow, JHVTableCellRenderer.cellEmphasisBorder);
    ...
    private static final Map<String, SpaceObject> objectMap = Collections.unmodifiableMap(new LinkedHashMap<String, SpaceObject>() {
        {
            ...
            put("SOHO", new SpaceObject("SOHO", "SOHO", 2 / Sun.RadiusMeter, BufferUtils.colorWhite, JHVTableCellRenderer.cellBorder));
            put("STEREO Ahead", new SpaceObject("STEREO%20Ahead", "STEREO Ahead", 2 / Sun.RadiusMeter, BufferUtils.colorWhite, JHVTableCellRenderer.cellBorder));
            put("STEREO Behind", new SpaceObject("STEREO%20Behind", "STEREO Behind", 2 / Sun.RadiusMeter, BufferUtils.colorWhite, JHVTableCellRenderer.cellBorder));
            put("PROBA-2", new SpaceObject("PROBA2", "PROBA-2", 2 / Sun.RadiusMeter, BufferUtils.colorWhite, JHVTableCellRenderer.cellBorder));
            put("SDO", new SpaceObject("SDO", "SDO", 2 / Sun.RadiusMeter, BufferUtils.colorWhite, JHVTableCellRenderer.cellEmphasisBorder));

            put("Solar Orbiter", new SpaceObject("Solar%20Orbiter", "Solar Orbiter", 2 / Sun.RadiusMeter, BufferUtils.colorWhite, JHVTableCellRenderer.cellBorder));
            put("Parker Solar Probe", new SpaceObject("SPP", "Parker Solar Probe", 2 / Sun.RadiusMeter, BufferUtils.colorWhite, JHVTableCellRenderer.cellBorder));
            put("PROBA-3", new SpaceObject("PROBA3", "PROBA-3", 2 / Sun.RadiusMeter, BufferUtils.colorWhite, JHVTableCellRenderer.cellBorder));
        }
    });
