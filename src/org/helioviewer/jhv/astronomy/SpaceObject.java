...
public class SpaceObject {
    ...
    public static final SpaceObject STA = new SpaceObject(true, "STEREO AHEAD", "STEREO Ahead", 2 / Sun.RadiusMeter, Colors.bytes(32, 32, 128), JHVTableCellRenderer.cellBorder);
