...
public class PfssData {
	...
	public void init(GL gl) {
		if (gzipFitsFile != null) {
			...
			if (!init && read && gl != null) {
				...
				gl.glBufferDataARB(GL.GL_ARRAY_BUFFER, vertices.limit()
				...
				if (indicesSunToSun != null && indicesSunToSun.limit() > 0) {
					...
					gl.glBufferData(GL.GL_ELEMENT_ARRAY_BUFFER,
							indicesSunToSun.limit() * BufferUtil.SIZEOF_INT,
				...
				if (indicesSunToOutside != null
					...
					gl.glBufferData(
							...
							indicesSunToOutside.limit() * BufferUtil.SIZEOF_INT,
				...
				if (indicesOutsideToSun != null
					...
					gl.glBufferData(
							GL.GL_ELEMENT_ARRAY_BUFFER,
							indicesOutsideToSun.limit() * BufferUtil.SIZEOF_INT,
	...
	public void display(GL gl) {
		...
		if (indicesSunToSun != null && indicesSunToSun.limit() > 0) {
			...
			gl.glDrawElements(GL.GL_LINES, indicesSunToSun.limit(),
		...
		if (indicesSunToOutside != null && indicesSunToOutside.limit() > 0) {
			...
			gl.glDrawElements(GL.GL_LINES, indicesSunToOutside.limit(),
					GL.GL_UNSIGNED_INT, 0);
		}
		...
		if (indicesOutsideToSun != null && indicesOutsideToSun.limit() > 0) {
			...
			gl.glDrawElements(GL.GL_LINES, indicesOutsideToSun.limit(),
					GL.GL_UNSIGNED_INT, 0);
		}
