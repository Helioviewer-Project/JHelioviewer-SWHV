...
public class GL3DVec3f {
    ...
    public GL3DVec3f add(GL3DVec3f vec) {
        this.x += vec.x;
        this.y += vec.y;
        this.z += vec.z;
        return this;
    ...
    public GL3DVec3f subtract(GL3DVec3f vec) {
        this.x -= vec.x;
        this.y -= vec.y;
        this.z -= vec.z;
        return this;
    ...
    public GL3DVec3f subtract(float s) {
        this.x -= s;
        this.y -= s;
        this.z -= s;
        return this;
    ...
    public GL3DVec3f divide(GL3DVec3f vec) {
    ...
    public GL3DVec3f divide(float s) {
        if (s == 0f)
            throw new IllegalArgumentException("Division by 0 not allowed!");
        this.x /= s;
        this.y /= s;
    ...
    public GL3DVec3f multiply(GL3DVec3f vec) {
        this.x *= vec.x;
        this.y *= vec.y;
        this.z *= vec.z;
        return this;
    ...
    public GL3DVec3f multiply(float s) {
        this.x *= s;
        this.y *= s;
        this.z *= s;
        return this;
