...
public class EVEState {
     ...
     * 
     * @return True is the mouse was dragged, false if the mouse was not
     *         dragged.
     */
    ...
    /**
     * Sets whether the mouse is dragged in the time interval pane at the
     * moment.
     * 
     * @param mouseDragging
     *            True is the mouse is dragged, false if the mouse is not
     *            dragged.
     */
     ...
     * moment.
     * 
     * @param mouseValueIntervalDragging
     *            True is the mouse is dragged, false if the mouse is not
     *            dragged.
     */
