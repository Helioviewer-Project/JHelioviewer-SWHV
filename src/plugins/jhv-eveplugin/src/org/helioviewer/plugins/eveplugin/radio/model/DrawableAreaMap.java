...
public class DrawableAreaMap {
    ...
    public String toString() {
        return "[source: x0: " + sourceX0 + " , y0: " + sourceY0 + " , x1: " + sourceX1 + ", y1: " + sourceY1 + ", width: " + (sourceX1 - sourceX0) + ", heigth " + (sourceY1 - sourceY0) + ";]" + "[destination: x0: " + destinationX0 + ", y0: " + destinationY0 + ", x1: " + destinationX1 + ", y1: " + destinationY1 + ", width: " + (destinationX1 - destinationX0) + ", height:" + (destinationY1 - destinationY0) + "]";
    }
}
