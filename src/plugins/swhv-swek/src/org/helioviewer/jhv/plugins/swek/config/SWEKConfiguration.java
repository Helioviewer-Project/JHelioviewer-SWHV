...
public class SWEKConfiguration {
    ...
    /**
     * Creates a SWEKConfiguration with an empty configuration version, not manually changed with an empty list of sources, event types and related events.
     *
     */
    public SWEKConfiguration() {
        ...
        this.sources = new ArrayList<SWEKSource>();
        this.eventTypes = new ArrayList<SWEKEventType>();
        this.relatedEvents = new ArrayList<SWEKRelatedEvents>();
    }

    /**
     * Creates a SWEK configuration based on the given configuration version, manually changed indication, list of sources, list of event types and list of related events.
     *
     * @param configurationVersion      The version of the configuration file
     * @param manuallyChanged           True is manually changed, false if not
     * @param sources                   List of SWEK sources
     * @param eventTypes                List of SWEK event types
     ...
     *
     * @return the manuallyChanged  True if the configuration file was manually change, false if not.
     */
     ...
     *
     * @param manuallyChanged   True if the configuration file was manually changed, false if not.
     */
     ...
     *
     * @param relatedEvents the relatedEvents to set
     */
