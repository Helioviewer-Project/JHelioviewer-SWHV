...
def main() -> None:
    parser = argparse.ArgumentParser(description="Send queued SAMP commands to JHelioviewer")
    ...
    if args.mode == "raw":
        ...
        print(json.dumps(send(movie_commands(args.path, args.size), args.socket), indent=2))
