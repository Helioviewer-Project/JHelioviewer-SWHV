...
Current JHV is the maintained reference. See [historical comparison](historical-comparison.md)
for the one-time checks against 4.4.0 through 5.5. No historical adapters are retained.
