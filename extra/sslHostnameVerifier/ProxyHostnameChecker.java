 ...
 */
package org.helioviewer.jhv.view.j2k.jpip.http.ssl;
...
public class ProxyHostnameChecker implements HostnameChecker {
    ...
    private Object getHostnameChecker() {
        ...
        try {
            @SuppressWarnings("unchecked") final Class<Object> hostnameCheckerClass = (Class<Object>) classLoader.loadClass("sun.security.util.HostnameChecker");
